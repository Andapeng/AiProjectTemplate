...
> 为 Agent 与人类提供 **第一眼入口**。新增条目请先更新本表。

## 如何用

1. 按 **关键词** 在下方表格查找链接。
2. 深入阅读 `entries/` 中具体文件。
3. 架构级「为什么」优先读 `docs/01-architecture/decision-records/`。
...
| 任务流程、DoD | 工作流 | [`../docs/08-todo/workflow.md`](../docs/08-todo/workflow.md) |
| 安全分级 | L0–L3 | [`../docs/10-governance/security-privacy.md`](../docs/10-governance/security-privacy.md) |

## 项目知识条目（Project Entries）

<!-- 复制本行添加：
| 关键词 | 一句话 | [`entries/your-topic.md`](entries/your-topic.md) |
-->

| 关键词 | 摘要 | 链接 |
|--------|------|------|
| 术语表（占位） | 统一领域术语中英对照 | [`entries/glossary.md`](entries/glossary.md) |
